...
export const metadata: Metadata = {
	title: 'William Seo - Web Developer',
	description:
	...
	authors: [{ name: 'William Seo' }],
	creator: 'William Seo',
	openGraph: {
		title: 'William Seo - Web Developer Portfolio',
		...
		siteName: 'William Seo - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: 'William Seo - Web Developer Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
